...
(function () {
    ...
    function parimparnulo() {
        ...
        if (numero == 0) {
            alert("El numero ingresado es nulo");
        } else if (numero % 2 == 0) {
    ...
    function eleccion() {
        ...
        switch (opcion) {
            case 'Suma':
                ...
                alert("la suma de sus 2 numeros es: " + resultado);
                break;
            case 'Resta':
                resultado = num1p3 - num2p3;
                alert("la resta de sus 2 numeros es: " + resultado);
                break;
            case 'Multiplicacion':
                resultado = num1p3 * num2p3;
                alert("la multiplicacion de sus 2 numeros es: " + resultado);
                break;
            case 'Division':
                resultado = num1p3 / num2p3;
                alert("la division de sus 2 numeros es: " + resultado);
                break;
            //default:
    ...
    function notas() {
        ...
        var Num = parseInt(prompt("ingrese la siguiente nota o ingrese 0 para salir"));
        while (Num > 0) {
            contador = contador + 1;
            acumulador = Num + acumulador;
            Num = parseInt(prompt("ingrese la siguiente nota o ingrese 0 para salir"));
        }
    ...
    function votos() {
        ...
        for (var contador = 0; contador < 5; contador++) {
            candidatos[contador] = parseInt(prompt("ingresa el numero correspondiente"));
